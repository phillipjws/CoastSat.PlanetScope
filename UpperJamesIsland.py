...
def setup_user_input_settings():
    ...
    settings = {
        'site_name': 'UPPER_JAMES_ISLAND',
        'cloud_threshold': 6,
        'extent_thresh': 95,
        'output_epsg': '3157',
        'aoi_kml': 'upper_james_island.kml',
        'transects': 'UPPER_JAMES_ISLAND_TRANSECTS.geojson',
        'downloads_folder': r'U:\PS_Imagery\Upper_James_Island',
