...
def setup_user_input_settings():
    ...
    settings = {
        'site_name': 'LOWER_SIDNEY_ISLAND',
        'cloud_threshold': 6,
        'extent_thresh': 95,
        'output_epsg': '3157',
        'aoi_kml': 'lower_sidney_island.kml',
        'transects': 'LOWER_SIDNEY_ISLAND_TRANSECTS.geojson',
        'downloads_folder': r'U:\PS_Imagery\Lower_Sidney_Island',
        ...
        'georef_im': 'LOWER_SIDNEY_ISLAND_im_ref.tif',
        'water_index': 'NDWI'
    }
    return settings
