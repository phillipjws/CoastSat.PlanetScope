...
def setup_user_input_settings():
    ...
    settings = {
        'site_name': 'ISLAND_VIEW_BEACH',
        'cloud_threshold': 6,
        'extent_thresh': 95,
        'output_epsg': '3157',
        'aoi_kml': 'island_view_beach.kml',
        'transects': 'ISLAND_VIEW_BEACH_TRANSECTS.geojson',
        'downloads_folder': r'U:\PS_Imagery\Island_View_Beach',
